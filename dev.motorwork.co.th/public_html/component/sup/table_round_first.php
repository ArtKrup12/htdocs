...
<div class="form-group col-md-12 pt-1" style="overflow: auto; height: calc(100vh - 280px);">
    <div class="form-group col-md-12 col-xs-12">
        <table id="list_round_pick_first" class="table table-hover table-bordered table-striped">
            ...
            $sql_select = "SELECT * FROM `tb_pick` 
                                LEFT JOIN  tb_sale_order_detail ON tb_sale_order_detail.so_detail_no = tb_pick.so_detail_no
                                LEFT JOIN tb_product ON tb_product.prod_id = tb_sale_order_detail.prod_id 
                                WHERE tb_pick.flag_pick = 'N' AND tb_pick.assign_no = '$assign_no'";
            ...
            $sql_select3 = "SELECT * FROM `tb_assign`
                                    ...
                                    WHERE tb_assign.so_id = '$so_id' AND tb_assign.assign_task = 'pick' AND tb_assign.assign_no = '$assign_no'  ;";
            ...
            while ($rowData = mysqli_fetch_assoc($query_select)) {
                ...
                $sql_select31 = "SELECT * FROM `tb_pick`
                        LEFT JOIN tb_pick_remark ON tb_pick_remark.pick_no = tb_pick.pick_no
                         LEFT JOIN  tb_remark ON tb_pick_remark.remark_id = tb_remark.remark_id
                         WHERE so_detail_no = '" . $rowData['so_detail_no'] . "' AND assign_no = '" . $assign_no . "' AND tb_pick_remark.emp_type = '1' ;";
...
//                echo $sql_select31 ;
        ...
        <span class="custom-btn btn-success">
            ...
            <?php echo $data_body31->pick_qty; ?>
        </span>
                            <span class="divider">|</span>
                            <span class="custom-btn btn-warning cancel">
            <?php
            $diff = $rowData['prod_qty'] - $data_body31->pick_qty;
            echo $diff;
            ?>
        </span>
                        </div>
                    ...
                    <td>
                        ...
                        $sql_select_rm_show = "SELECT * FROM `tb_pick`
                                                LEFT JOIN tb_pick_remark ON tb_pick_remark.pick_no = tb_pick.pick_no
                                                WHERE tb_pick.so_detail_no = '" . $rowData['so_detail_no'] . "' AND assign_no = " . $assign_no . " AND tb_pick_remark.emp_type = '2' ;";
            ...
            <div class="card-body px-5">
                <div class="row">
                    <div class="form-group col-md-6 col-6 ">
                        <label for="member pick">พนักงานหยิบ</label><br>
                        &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $data_footer->emp_name . ' ' . $data_footer->emp_surname; ?>
                        <div class="row mt-4">
                            <div class="form-group col-6">
                                <label for="member pick">ประเภทหมายเหตุ</label><br>
