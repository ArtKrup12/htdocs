...
) VALUES('$dataDoc->list','$dataDoc->cotton','$DateNow','$dataDoc->box_code','$dataDoc->box_number','$name','$DateNow','$id[$i]')";
$result=mysqli_query($conn,$sql);

$sql2="UPDATE tb_document_list SET name_withdraw = '$name',date_document_withdraw='$DateNow',status = '20' WHERE box_code = '$dataDoc->box_code' AND box_number = '$dataDoc->box_number' AND id = '$id[$i]' ";
