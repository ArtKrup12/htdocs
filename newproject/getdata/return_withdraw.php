...
//$result=mysqli_query($conn,$sql);
 $sql="UPDATE tb_history_withdraw SET name_return = '$name',date_return='$DateNow' WHERE box_code = '$dataDoc->box_code' AND box_number = '$dataDoc->box_number' AND name_return is null AND id_ref = '$id'";
$result=mysqli_query($conn,$sql);

$sql2="UPDATE tb_document_list SET name_withdraw = null,date_document_withdraw=null,status = '10' WHERE box_code = '$dataDoc->box_code' AND box_number = '$dataDoc->box_number' AND id = '$id' ";
