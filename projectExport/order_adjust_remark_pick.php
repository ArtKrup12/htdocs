...
$sale_detail_id=$_GET['sale_detail_id'];
		    ...
		    $sql1="SELECT * FROM  v_sale_detail_control  WHERE  sale_id='$sale_id' AND sale_detail_id='$sale_detail_id' ";
        ...
        $sql2="SELECT product_count FROM flag_detail_count WHERE sale_detail_id='$sale_detail_id' AND assign_id='$assign_id'";
	 ...
	 <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            ...
            <form role="form" method="post" action="order_adjust_remark_add_pick.php" id="barcodeForm" >
              <div class="box-body">
				...
				<div class="form-group col-md-3 col-xs-6">
					<label for="stock insert">จำนวนในใบขาย</label>
					<input type="text" class="form-control" id="product_qty"  name="product_qty" 
					placeholder="จำนวนในใบขาย" value="<?php echo $product_qty;?>" readonly >
                ...
                <div class="form-group col-md-3 col-xs-6">
					...
					<input type="number" class="form-control" id="product_dif"  name="product_dif" 
					placeholder="0"  style="color:red" value="<?php echo ($product_qty-$product_dif);?>" readonly autocomplete="off" >
				</div>	
                <div class="form-group col-md-3 col-xs-6">
          ...
          oninput="setCustomValidity('')"></textarea>
              ...
              <button type="submit" class="btn btn-primary" style="background-color:#9b111e;border-color: #961011" onclick="handleRedirect()" <?php if($product_code==''){ echo "disabled"; }else{ echo "";}?>><i class="fa fa-save"></i> บันทึก</button>
                <a href="order_scanner_pick.php?sale_id=<?php echo $sale_id ?>&product_code=<?php echo $product_code?>&assign_id=<?php echo $assign_id?>" class="btn btn-warning" style="background-color:#3A3B3C;border-color:#3A3B3C"><i class="fa fa-undo"></i> ย้อนกลับ</a>

				<input type="hidden" name="sale_id" value="<?php echo $sale_id;?>">
				<input type="hidden" name="assign_id" value="<?php echo $assign_id;?>">
				<input type="hidden" name="sale_detail_id" value="<?php echo $sale_detail_id;?>">
