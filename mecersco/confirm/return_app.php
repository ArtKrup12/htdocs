...
if(isset($_POST['return_app'])){

    $list_id = $_POST['return_app'] ;
    $i = 0 ;
    ...
    $update =  "UPDATE list 
    SET `List_status`= 'return_complete' 
    WHERE List_id = '$list_id' " ;
    $result = mysqli_query($conn,$update) ;

    $id = $_SESSION['Emp_id'] ;
    $insert_log = "INSERT INTO log_in_mecers(Who,Action) VALUES ('$id','อนุมัติการขอคืนเครื่องมือ')";
